...
// dotnet ef dbcontext scaffold "Data Source=localhost;Initial Catalog=Chinook;Integrated Security=True;TrustServerCertificate=True;" Microsoft.EntityFrameworkCore.SqlServer -o Models/Generated --force
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=localhost;Initial Catalog=Chinook;Integrated Security=True;TrustServerCertificate=True;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Customer>(entity =>
        {
            ...
            entity.HasOne(d => d.SupportRep).WithMany(p => p.Customers)
                ...
                .HasConstraintName("FK__Customer__Suppor__3F466844");
        });
        ...
        modelBuilder.Entity<Employee>(entity =>
        {
            ...
            entity.HasOne(d => d.ReportsToNavigation).WithMany(p => p.InverseReportsToNavigation)
                ...
                .HasConstraintName("FK__Employee__Report__3C69FB99");
        });
        ...
        modelBuilder.Entity<Invoice>(entity =>
        {
            ...
            entity.HasOne(d => d.Customer).WithMany(p => p.Invoices)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Invoice__Custome__440B1D61");
        });
        ...
        modelBuilder.Entity<InvoiceLine>(entity =>
        {
            ...
            entity.HasOne(d => d.Invoice).WithMany(p => p.InvoiceLines)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__InvoiceLi__Invoi__534D60F1");

            entity.HasOne(d => d.Track).WithMany(p => p.InvoiceLines)
                .HasForeignKey(d => d.TrackId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__InvoiceLi__Track__5441852A");
        });
            ...
            entity.HasMany(d => d.Tracks).WithMany(p => p.Playlists)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    r => r.HasOne<Track>().WithMany()
                        ...
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__PlaylistT__Track__5070F446"),
                    l => l.HasOne<Playlist>().WithMany()
                        .HasForeignKey("PlaylistId")
                        .OnDelete(DeleteBehavior.ClientSetNull)
                        .HasConstraintName("FK__PlaylistT__Playl__4F7CD00D"),
                    j =>
                    {
        ...
        modelBuilder.Entity<Track>(entity =>
        {
            ...
            entity.HasOne(d => d.Album).WithMany(p => p.Tracks)
                ...
                .HasConstraintName("FK__Track__AlbumId__4AB81AF0");

            entity.HasOne(d => d.Genre).WithMany(p => p.Tracks)
                .HasForeignKey(d => d.GenreId)
                .HasConstraintName("FK__Track__GenreId__4BAC3F29");

            entity.HasOne(d => d.MediaType).WithMany(p => p.Tracks)
                .HasForeignKey(d => d.MediaTypeId)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__Track__MediaType__4CA06362");
        });
